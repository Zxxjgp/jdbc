...
/*		thumbnailatorTest.test2();
	...
	private void test1() throws IOException {
		...
		Thumbnails.of(ResourceUtils.getFile("classpath:images/test.jpg").getAbsolutePath()).size(1024, 1024).toFile(
				"D:/image_200x300.jpg");
	}
	...
	private void test2() throws IOException {
		 ...
		 * scale(比例)
		 */
		Thumbnails.of(ResourceUtils.getFile("classpath:images/test.jpg").getAbsolutePath()).scale(0.25f)
				.toFile("D:/image_200x300.jpg");
	}
	...
	private void test4() throws IOException {
		 ...
		 */
		Thumbnails.of(ResourceUtils.getFile("classpath:images/test.jpg").getAbsolutePath()).size(1280, 1024).rotate(90).toFile(
				"D:/image+90.jpg");
		Thumbnails.of(ResourceUtils.getFile("classpath:images/test.jpg").getAbsolutePath()).size(1280, 1024).rotate(-90).toFile(
				"D:/iamge-90.jpg");
	}
	...
	private void test5() throws IOException {
		 ...
		 */
		Thumbnails.of(ResourceUtils.getFile("classpath:images/test.jpg").getAbsolutePath()).size(1280, 1024).watermark(
				Positions.BOTTOM_RIGHT,
				ImageIO.read(new File("D:/qw.jpg")), 0.5f)
				.outputQuality(0.8f).toFile(
						"D:/image_watermark_bottom_right.jpg");
		Thumbnails.of(ResourceUtils.getFile("classpath:images/test.jpg").getAbsolutePath()).size(1280, 1024).watermark(
				Positions.CENTER,
				ImageIO.read(new File("D:/qw.jpg")), 0.5f)
